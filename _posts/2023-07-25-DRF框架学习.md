...
- 输入 [3.2. 数据迁移，创建管理用户](#3.2.%20数据迁移，创建管理用户) 中创建的用户名密码【admin:admin123】
![](/assets/images/2307/Pasted%20image%2020230728104223.png)
- 进入如下页面
